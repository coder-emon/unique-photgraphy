            ...
            <div className="max-w-sm max-h-sm">
                ...
                >
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <button className='rounded-lg bg-red-700 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-red-800 focus:outline-none focus:ring-4 focus:ring-blue-300 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-blue-800'>Delete</button>
                    </div>
                </Card>
            </div>
        </div>
